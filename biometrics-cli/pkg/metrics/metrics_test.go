...
func TestRecordAuditEvent(t *testing.T) {
	...
	assert.Contains(t, metrics, "biometrics_audit_events_total")
...
func TestRecordAuthAttempt(t *testing.T) {
	...
	assert.Contains(t, metrics, "biometrics_auth_attempts_total")
}
...
func TestRecordAuthFailure(t *testing.T) {
	...
	assert.Contains(t, metrics, "biometrics_auth_failures_total")
}
...
func TestRecordRateLimitRequest(t *testing.T) {
	...
	assert.Contains(t, metrics, "biometrics_ratelimit_requests_total")
...
func TestCreateCounterVec(t *testing.T) {
	...
	metrics, err := registry.CollectAll()
	require.NoError(t, err)
	assert.Contains(t, metrics, "test_counter_vec")
}
