...
|-------|---------------|---------|
| ALL AGENTS | google/gemini-3-flash | Stable, high-context, fast execution (Single Model Policy) |
| Sisyphus | google/gemini-3-flash | Primary orchestrator |
| oracle | google/gemini-3-flash | Read-only consultation. High-IQ debugging, architecture |
| librarian | google/gemini-3-flash | Multi-repo analysis, docs |
| explore | google/gemini-3-flash | Fast codebase exploration |
| frontend-ui-ux-engineer | google/gemini-3-flash | UI generation |
| document-writer | google/gemini-3-flash | Technical docs |
| multimodal-looker | google/gemini-3-flash | PDF/image analysis |
| Prometheus (Planner) | google/gemini-3-flash | Strategic planning, interview-driven |
| Metis (Plan Consultant) | google/gemini-3-flash | Pre-planning analysis |
| Momus (Plan Reviewer) | google/gemini-3-flash | Plan validation |
